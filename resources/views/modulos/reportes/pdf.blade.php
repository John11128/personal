...
<body>
    ...
    <div class="meta">
        Generado: {{ now()->format('d/m/Y H:i') }} Por el Usuario: {{ auth()->user()->name ?? 'Sistema' }}
    </div>
    ...
    <footer>Generado por SisInvPer - {{ now()->format('d/m/Y') }} Generado por {{ auth()->user()->name ?? 'Sistema' }}</footer>
</body>
</html>